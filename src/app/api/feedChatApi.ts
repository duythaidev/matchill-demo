...
export let MOCK_POSTS: Post[] = [
  {
    ...
    content: 'Tìm 2 người chơi cầu lông doubles cuối tuần này 🏸 Sân Sky Court Q1, thứ 7 lúc 7h sáng. Ai muốn tham gia comment bên dưới nhé!',
    ...
    comments: [
      ...
      },
      {
        ...
        content: 'Mình ở Q1 nè, nhưng tay còn yếu lắm 😅 có chấp không?',
  ...
  },
  {
    ...
    sport: 'Tennis',
    location: 'VTF Tennis Academy, Quận 2',
  ...
  },
  {
    ...
    sport: 'Football',
    location: 'Champion Football Field, Quận 7',
  ...
  },
  {
    ...
    content: 'Ai chơi Pickleball ở khu Thủ Đức không? Mình mới tập được 6 tháng, muốn tìm nhóm chơi thường xuyên gần nhà. Tốt nhất là buổi chiều sau 17h hoặc buổi sáng cuối tuần 🏓',
    sport: 'Pickleball',
    ...
    comments: [
      {
        ...
        authorName: 'Tran Thi Mai',
        authorAvatar: 'https://images.unsplash.com/photo-1659081443046-268bee889587?w=200&h=200&fit=crop',
        content: 'Mình chơi pickleball khu Q2! Không quá xa, bạn có thể qua sân Pickleball Zone thử không?',
...
export const MOCK_MESSAGES: Record<string, Message[]> = {
  ...
  chat_private_2: [
    ...
    },
    {
      ...
      senderName: 'Le Minh Quan',
      senderAvatar: 'https://images.unsplash.com/photo-1762830445441-bf72461f4799?w=200&h=200&fit=crop',
      text: 'Thứ 4 tuần này 6h tối, sân Pro Badminton Club ở Bình Thạnh. Em đến được không?',
      createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000 + 10 * 60 * 1000).toISOString(),
      seenBy: ['p3', 'me'],
    },
    {
  ...
  chat_private_3: [
    {
      ...
      text: 'Chào! Mình thấy bạn muốn tìm đối tác tennis? Mình ở Q2 nhé',
      createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      seenBy: ['p5', 'me'],
    },
    {
